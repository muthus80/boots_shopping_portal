"""Sprint 2 integration test conftest.

Provides:
- db_session and async_client from base conftest (re-exported)
- Helpers to register/login a user and obtain an auth token
- Sprint-specific fixture factories for products, categories, cart, orders
"""
...
async def create_product_in_db(
    ...
    product = Product(
        name=name,
        slug=slug,
        description="A test boot with waterproof features and leather upper.",
